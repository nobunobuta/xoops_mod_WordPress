...
// Sub menu titles
define("_MI_WORDPRESS_SMNAME1","Submit Blog");
// Sample Blog Message
...
define("_MI_WORDPRESS_INST_OPTIONS_22","'en'");
...
define("_MI_WORDPRESS_BNAME2","WordPress%s Monthly Archives");
define("_MI_WORDPRESS_BDESC2","WordPress Monthly Archives");

define("_MI_WORDPRESS_BNAME3","WordPress%s Categories Listing");
define("_MI_WORDPRESS_BDESC3","WordPress Categories Listing");

define("_MI_WORDPRESS_BNAME4","WordPress%s Link Listing");
define("_MI_WORDPRESS_BDESC4","WordPress Link Listing");

define("_MI_WORDPRESS_BNAME5","WordPress%s Blog Search");
define("_MI_WORDPRESS_BDESC5","WordPress Blog Search");

define("_MI_WORDPRESS_BNAME6","WordPress%s Recent Posts");
define("_MI_WORDPRESS_BDESC6","WordPress Recent Posts");

define("_MI_WORDPRESS_BNAME7","WordPress%s Recent Comments");
