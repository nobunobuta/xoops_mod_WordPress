...
define("_MI_WP_USE_BLOCKCSSHEADER_DESC","BLOCKのCSS指定を、HTMLのヘッダ部分でリンクします。<br/>XOOPSテンプレートのtheme.html内の&lt;{&amp;xoops_module_header}&gt;の下行に、&lt;{&amp;xoops_block_header}&gt;を挿入する必要があります。");
