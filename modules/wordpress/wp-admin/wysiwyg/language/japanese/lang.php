...
define('_XK_FONT','フォント');
define('_XK_FONT_SIZE','サイズ');
...
define('_XK_UNDERLINE','下線');
define('_XK_STRIKETHROUGH','取消線');
define('_XK_REMOVEFORMAT','書式削除');
define('_XK_JUSTIFYLEFT','左寄せ');
define('_XK_JUSTIFYCENTER','中央寄せ');
define('_XK_JUSTIFYRIGHT','右寄せ');
define('_XK_JUSTIFYFULL','均等割付');
define('_XK_NEWPARAGRAPH','Turn On/Off New Paragraph Mode');
define('_XK_INSERTORDEREDLIST','番号リスト');
define('_XK_INSERTUNORDEREDLIST','リスト');
define('_XK_SPELLCHECK','スペルチェック');
define('_XK_PRINT','印刷');
define('_XK_INDENT','インデント');
define('_XK_OUTDENT','逆インデント');
define('_XK_SUPERSCRIPT','上付き');
define('_XK_SUBSCRIPT','下付き');
define('_XK_CODE','Code');
define('_XK_QUOTE','Quote');
define('_XK_CREATELINK','リンク作成');
define('_XK_UNLINK','リンク削除');
define('_XK_INSERTHORIZONTALRULE','水平線');
define('_XK_INSERTANCHOR','Insert Anchor');
define('_XK_CREATEQUICKTABLE','Insert Quick Table');
define('_XK_INSERTIMAGE','画像挿入');
define('_XK_INSERTIMAGEM','Image Manager');
define('_XK_FLOAT','Floating/Static Toolbar');
define('_XK_SYMBOLS','特殊記号');
define('_XK_INSERTDATE','日時挿入');
