...
class XoopsFormWysiwygTextArea extends XoopsFormElement {
    ...
    * @param string $name Wysiwyg textarea name (MUST BE UNIQUE!!)
    * @param array $options Toolbar Options
    * @param string $value Initial text
    * @param string $width iframe width
    * @param string $height iframe height
    * @param string $skin editor skin
    */
    function XoopsFormWysiwygTextArea($caption, $name, $value = '', $width = _XK_P_WIDTH, $height = _XK_P_WIDTH, $options = '', $skin = _XK_P_SKIN)
    {
        $this->setUrl(_XK_P_PATH);
        ...
        $this->setSkin($skin);
        $this->setFonts('');
        $this->setDirection(_XK_P_TDIRECTION);
    } 
    ...
    function setFonts($fonts)
    {
        ...
        if (empty($fonts))$this->fonts = $deffonts;
    ...
    {
        if ($options == 'small')$this->options = explode(",", _XK_P_SMALLTOOLBAR);
        else if (is_array($options))$this->options = $options;
        else $this->options = explode(",", _XK_P_FULLTOOLBAR);
    } 
