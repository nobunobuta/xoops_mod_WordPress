...
<p><a class='delete' href="post.php?action=confirmdeletecomment&amp;noredir=true&amp;comment=<?php echo $commentdata['comment_ID']; ?>&amp;p=<?php echo $commentdata['comment_post_ID']; ?>"><?php echo _LANG_EFA_DEL_THISPOST?></a>.</p>
</div>
