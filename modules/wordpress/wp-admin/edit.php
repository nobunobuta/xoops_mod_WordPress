...
$post_per_page = intval($_GET['posts_per_page']);
$poststart = intval($_GET['poststart']);
$postend = intval($_GET['postend']);
$order = $_GET['order'];
...
?>
<ul id="adminmenu2">
	<li><a href="edit.php" class="current"><?php echo _LANG_E_LATEST_POSTS; ?></a></li>
	<li><a href="edit-comments.php"><?php echo _LANG_E_LATEST_COMMENTS; ?></a></li>
