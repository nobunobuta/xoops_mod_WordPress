...
define('_LANG_WA_SETTING_GUIDE','<p>Anscheinend ist WP noch nicht installiert. AusfÙ˛ren: <a href=\'wp-admin/install.php\'>install.php</a>.</p>');
...
define('_LANG_WA_CONFIG_GUIDE1','<p>Die Datei \'wp-config.php\' exisitiert bereits. Sollte es notwendig sein, Parameter in dieser Datei zu Ù˛dern, ist die alte Datei vorher zu lÙ˛chen.</p>');
define('_LANG_WA_CONFIG_GUIDE2','<p>Achtung, eine wp-config-sample.php ist notwendig um fortzufahren. Bitte erneut uploaden.<p>');
define('_LANG_WA_CONFIG_GUIDE3','<p>Achtung, in das Verzeichnis kann nicht geschrieben werden. Entweder muss die Verzeichnisberechtigung geÙ˛dert werden, oder die Datei wp-config.php manuell erstellt werden.</p>');
define('_LANG_WA_CONFIG_GUIDE4','Willkommen bei WordPress. Bevor es losgehen kann, sind einige Daten bzgl. der Datenbank notwendig. Folgende Informationen mÙ˛sen bekannt sein:');
...
define('_LANG_WA_CONFIG_GUIDE10','<small>In 99% aller FÙ˛le muss dieser Wert nicht geÙ˛dert werden.</small>');
define('_LANG_WA_CONFIG_GUIDE11','<small>Sollen multiple WP Installationen in einer einzigen Datenbnak laufen, bitte diesen Wert Ù˛dern.</small>');
define('_LANG_WA_CONFIG_GUIDE12','Ok mein Freund! Diesen Teil der Installation kannst Du jetzt vergessen. WordPress kann nÙ˛lich mit der Datenbank kommunizieren. Wenn Du soweit bist, geht es jetzt los mit <a href="install.php">der Installation!</a>');


/* File Name wp-include/wp-db.php */
define('_LANG_WA_WPDB_GUIDE1','<strong>Fehler beim Aufbau einer Datenbankverbindung!</strong> Wahrscheinlich stimmen die Verbindungsadten in der Datei <code>wp-config.php</code> nicht. Bitte Ù˛erprÙ˛en und nochmals versuchen.');
define('_LANG_WA_WPDB_GUIDE2','Stimmt die User/Passwort Kombination?');
define('_LANG_WA_WPDB_GUIDE3','Stimmt der Hostname?');
define('_LANG_WA_WPDB_GUIDE4','LÙ˛ft der Datenbankserver?');
...
define('_LANG_F_DELETE_VISIT','Um den Kommentar zu lÙ˛chen, hier klicken:');
...
define('_LANG_R_ADDRESS_CORRECT','<strong>FEHLER</strong>: Die Emailadresse ist ungÙ˛tig.');
define('_LANG_R_CHOOSE_ANOTHER','<strong>FEHLER</strong>: Dieses Login ist bereits vergeben, bitte ein Anderes wÙ˛len.');
...
define('_LANG_R_R_CLOSED','User Registrierungen sind zur Zeit nicht mÙ˛lich.');
...
define('_LANG_L_DISABLED_FUNC','M&ouml;glicher Grund: Dein Host unterstÙ˛zt die mail()-Funktion nicht...');
define('_LANG_L_SUCCESS_SEND',' : Email erfolgreich versandt.');
define('_LANG_L_CLICK_ENTER','Hier klicken fÙ˛ Login!');
...
define('_LANG_E_FILL_REQUIRED','Fehler: bitte die notwendigen Felder ausfÙ˛len (Name & Kommentar)');
...
define('_LANG_WPCM_COM_RSS','<abbr title="Really Simple Syndication">RSS</abbr> Feed fÙ˛ Kommentare zu diesem Post.');
...
define('_LANG_WAO_READING_GZIP','WP soll Beitr&auml;ge komprimieren (gzip) falls der Browser dies unterstÙ˛zt');
