...
define('_LANG_P_DATARIGHT_EDIT','この投稿を編集することは出来ません。');
define('_LANG_P_DATARIGHT_DELETE','この投稿を削除する権限がありません。');
...
define('_LANG_P_CONFIRM_DELETE', '本当に削除してもよろしいですか？');
...
define('_LANG_EFA_POST_CUSTOM','カスタムフィールド');
...
define('_LANG_WLC_DONOT_DELETE','IDが1のカテゴリーは削除する事ができません');
...
define('_LANG_WLC_SUBCATE_MINIDESC','説明?');
...
define('_LANG_ADMIN_MENU_WRITE','投稿');
define('_LANG_ADMIN_MENU_EDIT','編集');
define('_LANG_ADMIN_MENU_CATE','カテゴリー');
define('_LANG_ADMIN_MENU_LINK','リンク');
define('_LANG_ADMIN_MENU_USER','ユーザー');
define('_LANG_ADMIN_MENU_OPTION','オプション');
define('_LANG_ADMIN_MENU_PLUG','プラグイン');
define('_LANG_ADMIN_MENU_TEMP','テンプレート');
define('_LANG_ADMIN_MENU_UPLOAD','アップロード');
define('_LANG_ADMIN_MENU_PROFILE','プロフィール');
define('_LANG_ADMIN_MENU_VIEW','サイト表示 &raquo;');
define('_LANG_ADMIN_MENU_LOGOUT','ログアウト (%s)');
...
define('_LANG_WAS_SIDE_AGAIN','続けて投稿するには<a href="sidebar.php" target="_self">こちら</a>をクリック');
...
define('_LANG_WPCM_COM_RSS','このコメントの<abbr title="Really Simple Syndication">RSS</abbr>');
...
define('_LANG_INST_BASE_VALUE12','**bold** \\\\italic\\\\ __underline__のような<br>GreyMatter-styleを使用する');
define('_LANG_INST_BASE_VALUE13','ボタンによるクイックタグを使用する (Mac IEでは利用できません)');
define('_LANG_INST_BASE_VALUE14','重要! 中国語、日本語、韓国語その他のマルチバイト言語での<br>使用時には必ず[false]にしてください');
define('_LANG_INST_BASE_VALUE15','タグを許可した場合、それが悪い結果を招く場合があります。<br>利用状況にもよりますが[false]にすることをお勧めします');
define('_LANG_INST_BASE_VALUE16','投稿時にスマイリーアイコンの使用を許可することで、<br>微妙なニュアンスを伝えることが可能となります');
define('_LANG_INST_BASE_VALUE17','スマイリーアイコンのあるディレクトリを指定 (最後のスラッシュは不要)');
define('_LANG_INST_BASE_VALUE18','コメント投稿時に名前とメールアドレスの入力を必須にする。<br>[false]にすると、それらが未記入でもコメントを投稿することが出来ます');
define('_LANG_INST_BASE_VALUE20','コメントが投稿された際メール通知する');
/* rss/rdf feeds */
define('_LANG_INST_BASE_VALUE21','RSSに出力する記事数');
define('_LANG_INST_BASE_VALUE22','RSSに出力する言語<br>(参考:<a href="http://backend.userland.com/stories/storyReader$16" target="_blank">http://backend.userland.com/stories/storyReader$16</a>');
...
define('_LANG_INST_BASE_VALUE30','Pingbackの使用を許可するかしないかを設定してください<br>[false]にすると利用できなくなります。');
define('_LANG_INST_BASE_VALUE31','[true]でファイルのアップロードを許可、[false]で禁止');
define('_LANG_INST_BASE_VALUE32','画像をアップロードするディレクトリを絶対パスで指定してください<br>(最後のスラッシュは不要)　サーバーがUNIX環境の場合は、<br>該当ディレクトリのパーミッションを[766]以上にしてください');
define('_LANG_INST_BASE_VALUE33','そのディレクトリーのURLを入力します<br>(アップロードされたファイルへのリンクを生成するために使用されます)<br>こちらも最後のスラッシュは不要です');
define('_LANG_INST_BASE_VALUE34','許可するファイルタイプを指定します このリストは増すことができます<br>(各ファイルタイプは半角スペースで区切ってください)');
define('_LANG_INST_BASE_VALUE35','アップロード可能なファイルサイズを指定してください。<br>ほとんどのサーバーでは2048KBに制限されています<br>(サーバーの限界値より高い値をセットしても意味がありません)');
define('_LANG_INST_BASE_VALUE36','ファイルのアップロードを許可するユーザーレベルを設定してください');
define('_LANG_INST_BASE_VALUE37','上の設定とは関係なく、管理人が設定した特定のユーザーだけファイルの<br>アップロードを許可することも出来ます。<br>その場合はこちらでユーザー名を指定します。<br>複数の場合は半角スペースで区切ってください。');
/* email settings */
...
define('_LANG_INST_BASE_VALUE44','ターミネーターストリング<br>(本文からこの文字列で始まる部分を削除する)');
define('_LANG_INST_BASE_VALUE45','[true]にするとテストモードになります');
define('_LANG_INST_BASE_VALUE46','ここを[true]にすることで、携帯電話のメールサービスなどからの<br>分割した内容でも一つの本文として調整されます');
define('_LANG_INST_BASE_VALUE47','メッセージを送信する際はログイン名に続けてパスワードを入れます。<br> 分割送信した文章を繋げるためのセパレーターストリングを<br>ここで指定してください。');
...
define('_LANG_INST_BASE_VALUE64','0の価値を指定します。 ここを[true]にした場合、<br>0は評価の基準になりません');
...
define('_LANG_INST_BASE_VALUE89','ここを[true]にしておくことで、承認待ちコメントがあることを<br>メールで通知可能になります。');
define('_LANG_INST_BASE_VALUE90','パーマネントリンクオプションについての詳しい説明は<a href="options-permalink.php">こちらのページ</a>でご覧いただけます。');
define('_LANG_INST_BASE_VALUE91','ファイル出力時にgzipを有効にするかどうかを選択してください。 <br>お使いのウェブサーバーApacheにmod_gzipというモジュールが<br>組み込まれていない場合は、ここを[true]にしてください。');
